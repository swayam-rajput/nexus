...
const PodCard = ({title,imgsrc}) => {
    ...
    return (
        <div className="flex flex-col sm:w-80 w-96 gap-4 p-6 rounded-lg justify-between  border-2 transition border-slate-200 shadow  hover:border-slate-300">
            <div className="mt-4 transition duration-700 rounded-lg">
                <AspectRatio ratio={4/3}>
                    {/* < Image placeholder="blur" blurDataURL="/ep1.jpg" width={800} height={600} className="flex rounded-xl outline-none  w-full object-scale-down" src="/ep1.jpg" alt=""/> */}
                    <HeroVideoDialogDemo/>
